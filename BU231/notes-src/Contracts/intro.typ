#let Contracts_Intro = [
  ...
  This seems to be due to their observations about how the courts sometimes handle similar court cases, giving contradictory verdicts without any certainty. Their hypothesis is that the courts are actually *manipulating the rules* to choose who they want to win. So no one really knows the rules!
  ...
  However, this is a bit of a failure as lawyers keep piling on $infinity$ numbers of exceptions as $t arrow infinity$, so there is never a precedent! Keep this in mind with contract law - past contract rulings might basically have no effect.
  
  === Equity VS Common Law
  Another thing to remember is how *equity* plays into the law - what is deemed fair. This could be yet another exception! For example things like equitable remedies I guess.
