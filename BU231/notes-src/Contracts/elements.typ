#let Contracts_Elements_Offer_Acceptance = [
  ...
  *Standard Form Contracts* (*Contracts of Adhesion*) are "take it or leave it" offers, where there is no room for negotiation and you are essentially forced into taking the offer. The most prominent example is that of the parking lot ticket. Although they are fast and easy (and needed for a lot of businesses to run in linear time), they leave the offeree with highly unequal bargaining power and they cannot negotiate terms at all. The question is - how would a consumer get out of the contract?
  ...
  The specific test for ambiguity is to check that the clause is broad enough to encompass negligence (ex. you can't sue us for negligence) and broad enough to encompass another cause of action (ex. also contract breach).
  ...
  *Revocation* allows offerors to cancel offers at any time *before acceptance*. This has 2 exceptions: *option contracts*, a separate contract where the right to revoke was bought; and *contracts under seal*, contracts with a red dot/X at the end of names (this also extends the litigation period since they are specialty contracts lol). _You cannot enforce irrevocability in the contract_.
  ...
  Offers usually aren't a one-and-done deal - negotiations can occur! When one side makes an offer, and the other side makes a *counter-offer* (any modification of the offer), the original offer is considered rejected and is immediately voided. Instead, the counter-offer is a *new offer* that can be accepted or rejected, and the process repeats.
...
#let Contracts_Elements_Consideration_Others = [
  ...
  ==== Gratuitous Promises
  If one party doesn't give up anything, it *does not count as Consideration*. Both promise something! This is why charities usually provide some sort of promise back (even a annual dinner is enough)
  ...
  *Past Consideration is not Consideration* - Consideration that occurred before the contract was signed *does not count*. In addition, continuing consideration (defined as performing an existing legal duty) doesn't count either - it needs to be *new consideration*.
  ...
  This was a whole debacle of events involving the _Foakes v. Beer_ case, where a debtor could only pay partially, which the creditor originally accepted. They then sued for breach of the original debt contract. The courts ruled in favour of the creditor - since the debtor has not given up *new consideration* (they're getting a freebie with debt relief), thus no new contract was formed & remaining still owed.

  Immediately after that though, legislatures across Canada immediately moved to pass the Mercantile Law Amendment Act - when a creditor *accepts* part performance (positive action of some \$) to settle a debt, and the debtor pays that partial amount in full, then the entire debt is extinguished. Despite lack of consideration, it's a binding agreement!
  
  ===== Sealed Contracts
  Seen earlier under revocation, sealed contracts do not require any consideration to be binding.
  ...
  #block(inset:(left: 1em))[
    ...
    2. Any contracts for non-continuous interests require *ratification* (acknowledgement and promise to perform) after they reach majority. This is required for example when you buy something where the payment happens after the date of majority.
  ]

  People who are have diminished mental capacity follow the same rules as a minor would.
  ...
  *Void* contracts refer to a contract that never existed, failing to form due to lack of requirements. *Voidable* contracts instead exist, but can be turned void at the option of one of the parties. If a contract is found void, the court tries its best to return the parties to their original positions. It can also decide only parts of a contract are void and *sever* (remove) those void parts of the contract.
  ...
  #block(inset: (left: 1em))[
    ...
    2. Labour Unions, Associations and other Organizations - unless they incorporate, its not a separate legal entity - use *representative action* (1 person represents group in court actions)
    3. Aboriginal Peoples living on Reservations - thanks outdated Indian Act. They are "special unincorporated associations" and have representative capacity like a labour union
  ...
  As for violating common law or public policy, this includes things like compensation (indemnity) for committing torts (bail out of consequences?), as well as contracts deemed immoral, a perversion of justice, or prejudicial to the interests of the Canadian public.

  Oh also a thing about the Competitions Act - technically NDAs are unenforceable unless in the context of sale of business and employment (which is what you usually see them in anyways). The enforcing clauses must be unambiguous in location, activity, and time period for it to be reasonable and enforceable.
  
  === Certainty of Terms
  The terms of a contract must be absolutely certain and unambiguous - if there is any vague or incomplete terms in the contract, it may be deemed *void* by the Courts, and thus no contract was ever formed.

  Examples of vague terms include:
  #block(inset:(left: 1em))[
     - *Fair Value* - instead of explaining how monetary value should be determined, they just use this or an equivalent term to waive it off. Not OK!
     - *Incomplete Contracts* - Contracts missing essential terms like price, whats being purchased, handover dates, and other items.
  ]
]