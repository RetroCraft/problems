#let Contract_Tidbits = [
   ...
   The Bankruptcy Act is based on the Debtor/Creditor Rule and its subsequent ruling! If you commit a act of bankruptcy (defined as owing more than \$1000 to 2+ creditors with no way to pay them down), you have 2 recourses:
   ...
   The Capacity requirement needed for different contracts may differ. For example, a marriage contract has really low capacity compared to say *Power of Attorney* - allowing someone else to deal with your *financial care* (managing your finances) or *personal care* (managing your life and even when to pull the plug) when you inevitably lose capacity to do so yourself.

   A general test for capacity is as follows:
   #block(inset:(left: 1em))[
     1. Do they have a sense of time?
     2. Do they have a sense of place? Where they live and so on?
     3. Do they know who those live near them are?
     4. Do they know of the size of their assets?
     5. Do they know the nature of the document they are about to sign?
   ]

   === Loopholing Damages for Negligent Misrepresentation
   Say hypothetically a misrepresentation is negligent but the courts feel it appropriate to void the contract AND award damages. This is not usually allowed since its a negligent misrepresentation, so only 1 can be chosen.

   The trick is to claim the existence of an *auxiliary contract* - if the main contract was not entered without having the auxiliary contract, the auxiliary contract follows all 7 needed elements for a contract, and voiding the original contract isn't enough to cover damages, this argument may be allowed and now there's 2 contracts you can recover damages with!  
]