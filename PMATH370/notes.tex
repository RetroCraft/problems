...
\begin{example}
  ...
  \begin{tikzpicture}
    ...
    \draw[fill=black] (1,0.7) circle (1 pt);
  \end{tikzpicture}
  creates an intersection of two points (i.e., a set with topological dimension 0),
...
\begin{example}
  ...
  \begin{center}
    \begin{tikzpicture}[use Hobby shortcut,closed=true,scale=0.5]
      ...
      \fill (-3.5,0.5) .. (-3,2.5) .. (-1,3.5).. (1.5,3).. (4,3.5).. (5,2.5).. (5,0.5) ..(2.5,-2).. (0,-0.5).. (-3,-2).. (-3.5,0.5);
      \draw[fill=none,white] (0.353,0.353) circle (0.4);
      \draw[dashed] (-3.5,1) arc(90:270:1);
      \draw[white] (-3.5,-1) arc(-90:90:1);
    \end{tikzpicture}
  \end{center}
  Then, the intersection of a ball's boundary
  will give either a circle or an arc, which have topological dimension 1,
