...
\begin{proof}
  ...
  $b=p_1^{\beta_1}p_2^{\beta_2}\cdots p_n^{\beta_n}$, and
  $k=p_1^{\kappa_1}p_2^{\kappa_2}\cdots p_n^{\kappa_n}$
  with non-negative $\alpha_i$, $\beta_i$, and $\kappa_i$.
  Notice that we may write $ak$ as a product of primes:
  $p_1^{\alpha_1+\kappa_1}p_2^{\alpha_2+\kappa_2}\cdots p_n^{\alpha_n+\kappa_n}$.

  Now, by GCD PF, we have $d=p_1^{\delta_1}p_2^{\delta_2}\cdots p_n^{\delta_n}$,
  where $\delta_i=\min(\{\alpha_i,\beta_i\})$ for all integers $1 \leq i \leq k$.
  Likewise, we have $g=p_1^{\gamma_1}p_2^{\gamma_2}\cdots p_n^{\gamma_n}$,
  where $\gamma_i=\min(\{\alpha_i+\kappa_i,\beta_i\})$.
